public class Kalgo extends BaseClassKnetwork
{
	...
	protected double quitError = 0.01;
	protected int retries = 10000;
	protected double reduction = .99;
	protected RecogChar owner;
	...
	public static void copyWeights(Kalgo dest, Kalgo source)
	{
	...
	void forceWin(int won[]) throws RuntimeException
	{
		...
		/*for(int j=0;j<inputNeuronCount;j++)
			System.out.println("optr[j]"+optr[j]);*/
	...
	public void learn() throws RuntimeException
	{
		...
		for (iter = 0;; iter++)
		{
			evaluateErrors(rate, won, bigerr, correc);
			totalError = bigerr[0];
